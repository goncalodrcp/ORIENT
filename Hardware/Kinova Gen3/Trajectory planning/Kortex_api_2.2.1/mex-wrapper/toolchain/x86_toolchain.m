function [tc, results] = x86_toolchain()
...
assembler.setName(['x86 ', version, ' Assembler']);
if ispc
...
compiler.setName(['x86 ', version, ' C Compiler']);
if ispc
...
cppcompiler.setName(['x86 ', version, ' C++ Compiler']);
if ispc
...
linker.setName(['x86 ', version, ' Linker']);
if ispc
...
cpplinker.setName(['x86 ', version, ' C++ Linker']);
if ispc
...
archiver.setName(['x86 ', version, ' Archiver']);
if ispc
