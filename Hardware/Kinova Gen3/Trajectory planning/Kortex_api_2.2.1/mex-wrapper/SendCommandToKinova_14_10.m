...
%%TEST 14/10
path = '/media/goncalopereira/DATA/IST/ORIENT_repos/Tests/ThesisSW/Data collected/Experiments_14_10/Sent/Z-Axis';
file = '/Z_A20_v18.mat';
fileLoad = strcat(path,file);
load(fileLoad);

%Choose file name to save later
pathSave = '/media/goncalopereira/DATA/IST/ORIENT_repos/Tests/ThesisSW/Data collected/Experiments_14_10/Feedback/Z-Axis';
fileToSave = '/Z_A20_v18_Sample1.mat';
