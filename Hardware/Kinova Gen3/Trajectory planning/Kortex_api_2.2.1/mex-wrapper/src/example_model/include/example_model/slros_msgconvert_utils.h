...
#ifndef _SLROS2_MSGCONVERT_UTILS_H_
#define _SLROS2_MSGCONVERT_UTILS_H_
...
class EnabledWarning : public ROSPropertyWarnStatus {
  public:
    ...
    inline void emitTruncationWarning(int numReceivedItems, int maxArraySize) const {
        numReceivedItems = numReceivedItems;
        maxArraySize = maxArraySize;
        RCLCPP_WARN(rclcpp::get_logger(SLROSNodeName), "Truncating array '%s' in received message '%s' from %d to %d items",
